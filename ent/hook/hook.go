...
// The AudioClipFunc type is an adapter to allow the use of ordinary
// function as AudioClip mutator.
type AudioClipFunc func(context.Context, *ent.AudioClipMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AudioClipFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AudioClipMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AudioClipMutation", m)
	}
	return f(ctx, mv)
}
...
func (f DiscordUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.DiscordUserMutation)
	if !ok {
...
// The VRCUserFunc type is an adapter to allow the use of ordinary
// function as VRCUser mutator.
type VRCUserFunc func(context.Context, *ent.VRCUserMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VRCUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.VRCUserMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VRCUserMutation", m)
	}
	return f(ctx, mv)
}
