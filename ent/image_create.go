...
func (ic *ImageCreate) SetStoragePath(s string) *ImageCreate {
	ic.mutation.SetStoragePath(s)
	return ic
}
...
func (ic *ImageCreate) createSpec() (*Image, *sqlgraph.CreateSpec) {
	...
	if value, ok := ic.mutation.StoragePath(); ok {
